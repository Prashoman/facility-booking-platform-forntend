...
const AboutPage: React.FC = () => {
  return (
    ...
    {/* Mission Statement */}
    <section className="bg-blue-800 shadow-md rounded-lg p-8 max-w-5xl mx-auto mb-12">
    ...
    <section className="max-w-7xl mx-auto mb-12 px-4 lg:px-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          <div
            key={index}
            className="bg-blue-700 shadow-lg rounded-lg p-6 text-center flex flex-col items-center"
          >
            <img
              src={member.img}
              alt={member.name}
    ...
    {/* Contact Information */}
    <section className="bg-blue-700 shadow-md rounded-lg p-8 max-w-5xl mx-auto">
